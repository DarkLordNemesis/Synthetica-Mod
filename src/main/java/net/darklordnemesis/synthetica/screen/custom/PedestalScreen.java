package net.darklordnemesis.synthetica.screen.custom;
...
public class PedestalScreen extends AbstractContainerScreen<PedestalMenu> {
    private static final ResourceLocation GUI_TEXTURE = ResourceLocation.fromNamespaceAndPath(Synthetica.MOD_ID, "textures/gui/pedestal/pedestal_gui.png");
