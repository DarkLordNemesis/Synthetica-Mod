...
import net.darklordnemesis.synthetica.item.custom.KatanaItem;
...
public class ModItems {
    ...
    public static final DeferredItem<Item> KATANA = ITEMS.register("katana", () -> new KatanaItem(Tiers.IRON,
            new Item.Properties()
                    .durability(250)
                    .attributes(SwordItem.createAttributes(Tiers.NETHERITE, 5, -1.2F))
    ));
